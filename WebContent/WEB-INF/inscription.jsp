	...
	<div class="card" style="width: 25rem; margin: auto;">
	  <div class="card-body">
	    ...
	    <form name="inscription" method="POST" action="${pageContext.request.contextPath}/inscription">
		  ...
		  <div class="form-group">
		    <input type="text" required  data-bv-notempty-message="Votre prénom est requis" class="form-control" name="prenom" id="prenom" placeholder="Votre prénom">
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		    <input type="text" required  data-bv-notempty-message="Votre numéro de téléphone est requis" class="form-control" name="tel" id="tel" placeholder="Votre numéro de téléphone">
		  </div>
